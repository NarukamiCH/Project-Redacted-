...
label exit_sex_menu_experienced_craving_lines(Girl):
    if Girl.tag == "Rogue":
...
label first_time_asking_lines(Girl, Action_type):
    if Girl.tag == "Rogue":
        ...
        if Action_type == "masturbation":
            ...
            $ lines.append("Hmm, so you'd like to try out some toys?")
...
label auto_rejected_lines(Girl, Action_type):
    if Girl.tag == "Rogue":
        ...
        $ lines = [
            ...
            f"Hmm, not yet, {Girl.player_petname}.",
...
label first_Action_approval_craving_lines(Girl, Action_type):
    if Girl.tag == "Rogue":
        $ lines = [
            "I guess. . .",
            "Hmm. . . ."]
...
label first_approval_lines(Girl, Action_type):
    if Girl.tag == "Rogue":
        $ lines = [
            "Hmm, could be fun. . .",
            "Sure. . .",
...
label first_Action_approval_mostly_love_lines(Girl, Action_type):
    if Girl.tag == "Rogue":
        ...
        if Action_type in kinky_Action_types:
            $ lines.append("If that's what you're into. . .")

        if Action_type == "blowjob":
            $ lines.append("I have wondered how you taste.")
...
label kiss_craving_lines(Girl, Action_type):
    if Girl.tag == "Rogue":
