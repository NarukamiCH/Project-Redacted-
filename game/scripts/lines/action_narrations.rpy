label kiss_narrations(Action):
    ...
    if Girl.History.check("kiss") > 10 and approval_check(Girl, "love", 70):
        $ lines = [
    ...
    elif Girl.History.check("kiss") > 5:
        $ lines = [
            f"{Girl.name} confidently presses her lips against yours.",
...
label handjob_narrations(Action):
    ...
    if not speed:
        ...
        if Girl.History.check("handjob") > 2:
    ...
    if Girl.History.check("handjob") > 4:
        if speed < 2:
            $ lines = [
            ...
            $ lines = [
                ...
                "She moves very smoothly, stroking casually and very gently, like she's been doing this for years.",
                "You can't tell where she is at any moment, all you know is that it works."]
    elif 2 < Girl.History.check("handjob") < 5:
        if speed < 2:
            $ lines = [
...
label footjob_narrations(Action):
    ...
    if not speed:
        if Girl.History.check("footjob") > 2:
            "She just seems to be enjoying the feel of it."
        else:
            "She just seems to be looking it over."

        return
    elif Girl.History.check("footjob") > 4:
        if speed < 2:
            $ lines = [
                "Her movements have become almost masterful, her slightest touch starts you twitching.",
                "She slowly caresses you in a way that makes your blood boil, then pulls back at the last second.",
...
label titjob_narrations(Action):
    ...
    if not speed:
        if Girl.History.check("titjob") > 2:
    ...
    if Girl.History.check("titjob") > 4 and Girl.History.check("blowjob"):
        if speed < 2:
            $ lines = [
    ...
    elif Girl.History.check("titjob") > 1:
        if speed < 2:
            $ lines = [
...
label blowjob_narrations(Action):
    ...
    if not speed:
        if Girl.History.check("blowjob") > 2:
    ...
    if speed == 1:
        if Girl.History.check("blowjob") > 4:
            $ lines = [
        ...
        elif Girl.History.check("blowjob") > 1:
            $ lines = [
...
label sex_narrations(Action):
    ...
    if not speed:
        ...
        "You continue to pound into [Girl.name]."
    else:
        "You continue to push into [Girl.name]."

    if Girl.History.check("sex") > 4:
        if speed > 1:
            $ lines = [
            ...
            $ lines = [
                "She bumps slowly against your cock.",
                ...
                "You slowly slide back and forth near her entrance.",
                "She slides slowly back and forth along your cock, teasing you."]
    elif Girl.History.check("sex") > 1:
        if speed > 1:
            $ lines = [
                "She bounces rapidly against your cock.",
                "You thrust into her and she squeaks a bit.",
...
label anal_narrations(Action):
    ...
    if Girl.History.check("anal") > 4:
        ...
        if speed > 1:
            $ lines = [
                "She bounces rapidly against your cock but seems to be in pain.",
                "You thrust into her and she squeaks in pain.",
                "You quickly grind back and forth inside her but she doesn't seem to have the rhythm down.",
                "She bounces rapidly against your cock, occasionally popping out and having to stick it back in.",
                "She moves rapidly back and forth along your cock, but seems a bit uncomfortable."]
            ...
            $ lines = [
                "She grits her teeth and slides slowly against your cock.",
                "You thrust into her and she squeaks a bit.",
                "You slowly grind back and forth inside her.",
                "You slowly slide back and forth near her rim.",
                "She slides slowly back and forth along your cock."]
