screen Action_menu():
    ...
    fixed anchor (0.5, 0.0) pos (0.12, 0.37) xysize (int(config.screen_width*0.2), int(config.screen_height*0.45)):
        viewport:
            ...
            showif (Player.mouth_Action.type or Player.hand_Action.type or Player.cock_Action.type) and (not Player.focused_Girl.mouth_Action.type or Player.focused_Girl.mouth_Action.type == "kiss"):
                button:
            ...
            showif not (Player.mouth_Action.type or Player.hand_Action.type or Player.cock_Action.type) or not (not Player.focused_Girl.mouth_Action.type or Player.focused_Girl.mouth_Action.type == "kiss"):
                button:
                    background "#424242"
                    action None
                    text "Turn [Player.focused_Girl.name] around":
    ...
    fixed anchor (0.5, 0.0) pos (0.88, 0.37) xysize (int(config.screen_width*0.2), int(config.screen_height*0.45)):
        viewport:
            mousewheel True
            draggable True
