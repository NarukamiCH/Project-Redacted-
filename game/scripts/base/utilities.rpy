...
label change_Player_stat(flavor, update):
    ...
    if update > 0:
        show expression Text(f"+{update}", size = 40, color = "#FFFFFF") at stat_rising(0.75) onlayer screens
    elif update < 0:
        show expression Text(f"{update}", size = 40, color = "#FFFFFF") at stat_falling(0.75) onlayer screens
